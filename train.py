...
def main(args):
    ...
    if not os.path.isfile(os.path.join(SAVED_DATASET_DIR, args.f)): 
        ...
        create_data_set = DataframePrepAllMod(
            ...
            label=LABELS, frame_rate=args.frame_rate, max_size=args.max_size
        )
    ...
    train_cp(model, train_data, train_label, val_data, val_label, epochs=args.e, batch_size=args.batch, model_path=model_path)
